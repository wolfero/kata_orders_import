...
class CSVUtilsTest {
    ...
    void shouldWriteOrdersToCSV() throws IOException {
        ...
        String outputPath = "test_output.csv";
        CSVUtils.writeOrdersToCSV(orders, outputPath);

        try (FileReader reader = new FileReader("src/main/resources/export/" + outputPath);
        ...
        Files.deleteIfExists(Paths.get("src/main/resources/export/" + outputPath));
    }
}
